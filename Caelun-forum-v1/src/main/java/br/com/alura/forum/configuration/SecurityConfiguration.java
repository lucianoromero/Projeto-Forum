...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	/**
	 * Realizando a implementacao para liberar os acessos via GET o restante contina
	 * bloqueado
	 */
	@Override
	...
	/**
	 * Sobre escrita do metodo configure <br>
	 * Liberando as extensao para não dar erro no swagger
	 */
	@Override
